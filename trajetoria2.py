...
# X
plt.subplot(3, 1, 1)
plt.plot(sol.t, sol.y[0], label='x (m)', color='tab:blue', linewidth=3)
...
# Y
plt.subplot(3, 1, 2)
plt.plot(sol.t, sol.y[1], label='y (m)', color='tab:orange', linewidth=3)
...
# Z
plt.subplot(3, 1, 3)
plt.plot(sol.t, sol.y[2], label='z (m)', color='tab:green', linewidth=3)
...
# Phi plot
plt.subplot(3, 1, 1)
plt.plot(sol.t, phi, label='Phi (controlled)', color='g', linewidth=3)
...
# Theta plot
plt.subplot(3, 1, 2)
plt.plot(sol.t, theta, label='Theta (controlled)', color='b', linewidth=3)
...
# Psi plot
plt.subplot(3, 1, 3)
plt.plot(sol.t, psi, label='Psi (controlled)', color='r', linewidth=3)
